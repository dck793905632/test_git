...
<HTML>
	...
	<body>
		...
		<form id="Form1" name="Form1" action="${pageContext.request.contextPath}/user/list.jsp" method="post">
								...
								<c:forEach items="${page.list}" var="o" varStatus="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												...
												<c:if test="${o.state==2}">
													<a href="${pageContext.request.contextPath}/AdminOrderServlet?method=updateOrderState&oid=${o.oid}">待发货</a>
												</c:if>
												<c:if test="${o.state==3}">
													已发货
												</c:if>
											...
											<td align="center" style="HEIGHT: 22px" width="60%">
												<input type="button" value="订单详情" id="${o.oid}" class="myClass"/>
													...
													<%--
														...
														<tr><td><img src="/store/products/1/c_0002.jpg" width="50px"></td><td>XXX</td><td>XXX</td><td>XXX</td></tr>




														<tr>
															<td><img src="/store/products/1/c_0002.jpg" width="50px"></td>
															<td>XXX</td>
															<td>XXX</td>
															<td>XXX</td>
														</tr>--%>
			...
			<jsp:include page="/jsp/pageFile.jsp"/>
		</form>
	</body>
	<script>
$(function () {
